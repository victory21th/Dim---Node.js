angular
  .module('core')
  .controller('MainController', ['$scope', '$theme', '$timeout', 'progressLoader', 'wijets', '$location', 'auth',
    function($scope, $theme, $timeout, progressLoader, wijetsService, $location, auth) {
      'use strict';
