angular
  .module('core') //theme.core.directives
  ...
  .directive('panel', function() {
    ...
    return {
      ...
      templateUrl: 'app/views/templates/panel.html',
      link: function(scope, element, attrs) {
  ...
  .directive('tileLarge', function() {
    ...
    return {
      ...
      templateUrl: 'app/views/templates/tile-large.html',
      replace: true,
      transclude: true
    };
  })
  ...
  .directive('fauxOffcanvas', ['enquire', '$window', function(enquire, $window) {
    'use strict';
    return {
      restrict: 'AE',
      link: function() {
